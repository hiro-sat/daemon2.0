...
public:
    ...
    this( MySDL s , SDL_Renderer* r )
    {
        ...
        c = 255;
        /*           createFont( r,  g,  b ) */
        font[  0 ] = createFont( 0 , 0 , 0 );
        font[  1 ] = createFont( 0 , 0 , c );
        font[  2 ] = createFont( 0 , c , 0 );
        font[  3 ] = createFont( 0 , c , c );
        font[  4 ] = createFont( c , 0 , 0 );
        font[  5 ] = createFont( c , 0 , c );
        font[  6 ] = createFont( c , c , 0 );
        font[  7 ] = createFont( c , c , c );

        c = 80;
        font[  8 ] = createFont( 0 , 0 , 0 );
        font[  9 ] = createFont( 0 , 0 , c );
        font[ 10 ] = createFont( 0 , c , 0 );
        font[ 11 ] = createFont( 0 , c , c );
        font[ 12 ] = createFont( c , 0 , 0 );
        font[ 13 ] = createFont( c , 0 , c );
        font[ 14 ] = createFont( c , c , 0 );
        font[ 15 ] = createFont( c , c , c );
